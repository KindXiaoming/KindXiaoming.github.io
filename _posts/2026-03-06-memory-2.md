...
Various works have shown that memorization capacity (measured in bits) scales proportionally with the number of parameters when evaluated on randomly generated datasets.

* Jack Morris et al. report **3.6 bits per parameter** for transformers.  
* Tianyuan Zhang et al. report **2 bits per parameter** for SSMs.

Both architectures use **MLPs** as core components. This naturally motivates studying the memorization capacity of MLPs themselves.
